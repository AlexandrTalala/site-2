...
<?php if(theme_get_option('theme_header_show_headline')): ?>
	...
	<<?php echo $headline; ?> class="art-headline" data-left="29.56%">
...
<?php if(theme_get_option('theme_header_show_slogan')): ?>
	...
	<<?php echo $slogan; ?> class="art-slogan" data-left="10.72%"><?php bloginfo('description'); ?></<?php echo $slogan; ?>>
<?php endif; ?>

<div class="art-object267130174" data-left="0.3%"></div>

            </div>
<div class="art-textblock art-object897672064" data-left="99.4%">
    <?php get_search_form() ?>
</div>
